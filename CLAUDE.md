...
- **`app/page.tsx`** — Main landing page: hero with install command, "What is Ruuh?" explainer, how-it-works steps, features grid, Ollama/local model section, Android device skills section, installation breakdown, footer
